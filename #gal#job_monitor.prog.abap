...
CLASS lcl_jm_event_receiver IMPLEMENTATION.
  ...
  METHOD handle_user_command.
    ...
    CASE e_ucomm.
      ...
      WHEN 'DELETE'.
        l_result = /gal/common_dialog=>show_confirmation_dialog( title   = TEXT-003
                                                                 message = TEXT-004
...
CLASS lcl_0102_jm_event_receiver IMPLEMENTATION.
  METHOD handle_cm_request.
    DATA:
      l_disable_post_processing TYPE abap_bool,
    ...
    IF sy-subrc = 0.
      e_object->add_function( fcode = 'REBOOKING'
                              text  = TEXT-017 ).
      ...
      e_object->disable_functions( fcodes = lt_fcodes ).
    ENDIF.
  ENDMETHOD.                    "handle_cm_request
  ...
  METHOD handle_user_command.
    ...
    CASE e_ucomm.
      ...
      WHEN 'REBOOKING'.
        l_result = /gal/common_dialog=>show_confirmation_dialog( title   = TEXT-018
                                                                 message = TEXT-019
                                                                 style   = /gal/common_dialog=>dlg_style_yes_no ).
        IF l_result = /gal/common_dialog=>dlg_result_yes.
          TRY.
              l_job = /gal/job=>read_job_from_db( id  = g_dynp_0102-job_data-id ).
              l_job->post_process( ).
      ...
      WHEN 'DELETE'.
        l_result = /gal/common_dialog=>show_confirmation_dialog( title   = TEXT-022
                                                                 message = TEXT-023
                                                                 style   = /gal/common_dialog=>dlg_style_yes_no ).
        IF l_result = /gal/common_dialog=>dlg_result_yes.
          TRY.
              l_job = /gal/job=>read_job_from_db( id  = g_dynp_0102-job_data-id ).
              l_job->delete_from_db( force = abap_true ).
...
START-OF-SELECTION.
  AUTHORITY-CHECK OBJECT 'S_TCODE' ID 'TCD' FIELD '/GAL/JOB_MONITOR'.
  IF sy-subrc <> 0.
